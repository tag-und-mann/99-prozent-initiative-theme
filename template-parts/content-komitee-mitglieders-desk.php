...
<div class="komitee-persons">
    ...
    <div class="head-row">
        <div class="container-main">
            <div class="person-row-content">
                ...
                <div class="ort"><?php echo __('Kanton', 'economiesuisse'); ?></div>
            </div>
        </div>
    </div>
    ...
    <?php if($persons->post_count): ?>
        ...
        <div class="persons">
            ...
            <?php get_template_part( 'template-parts/content', 'komitee-mitglieders-loop-desk' ); ?>
        </div>
...
<script>
    new ScrollMagic.Scene({
        triggerElement: ".komitee-persons",
        triggerHook: 0.9,
        offset: 0
    })
        .setClassToggle(".komitee-persons", "visibleBlock")
        .addTo(controller);
</script>